...
[`@aws-sdk/client-iottwinmaker`](https://www.npmjs.com/package/@aws-sdk/client-iottwinmaker/v/3.830.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iottwinmaker@3.830.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/GPlWomLiLgF80+xDVemJz4YzymYVtbrOEHPu3fond6HC9UNVPL3qN1yrfPV+nL1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-iottwinmaker": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iottwinmaker@3.830.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iottwinmaker@3.830.0/index.min.mjs": "sha384-/GPlWomLiLgF80+xDVemJz4YzymYVtbrOEHPu3fond6HC9UNVPL3qN1yrfPV+nL1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-iottwinmaker/blob/refs/tags/3.830.0/LICENSE
```
